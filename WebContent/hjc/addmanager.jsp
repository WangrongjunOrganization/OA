...
<body>
<div id="man_zone">
  <form action="../reg.do"  onsubmit="return yanzheng();" method="post" name="form1" id="form1" >
    <div class="MainDiv">
        ...
        <tr>
          <td class="CPanel"><table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#464646" class="newfont03">
              ...
              <tr bgcolor="#FFFFFF">
                ...
                <td><div align="center">
                    <label>
                    <input name="explanation1" type="text" value="" size="10" />
                    </label>
                </div></td>
                <td><div align="center">
                    <label>
                    <input name="explanation2" type="text" value="" size="10" />
                    </label>
                </div></td>
                
                <td><div align="center">
                    <label>
                    <input name="explanation3" type="text"  onClick="WdatePicker()" readonly="readonly" value="" size="16" />
                    </label>
                </div></td>
