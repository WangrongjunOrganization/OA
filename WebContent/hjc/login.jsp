...
<script type="text/javascript">
	var error='<%=request.getSession().getAttribute("errormsg")%>';
	if(error!='' && error!='null')
		alert(error);
          ...
          <tr>
            <td height="190"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
				...
				<form name="form1" method="post" onSubmit=" return yanzheng();"  action="../login.do" >
                  <table width="320" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
					  ...
					  <input type="text" name="name" id="name" style="width:164px; height:32px; line-height:34px; background:url(../images/inputbg.gif) repeat-x; border:solid 1px #d1d1d1; font-size:9pt; font-family:Verdana, Geneva, sans-serif;">
					  </td>
                    </tr>
                    <tr>
                      ...
                      <td height="50">密码</td>
                      <td height="50">
					  <input type="password" name="pass" id="pass" style="width:164px; height:32px; line-height:34px; background:url(../images/inputbg.gif) repeat-x; border:solid 1px #d1d1d1; font-size:9pt; ">
					  </td>
                    </tr>
                    <tr>
                      <td height="40">&nbsp;</td>
