...
outlookbar.additem('显示所有入职员工', t, 'wrj/showTrialEmp.jsp')
outlookbar.additem('查询入职员工', t, 'wrj/selectTrialEmp.jsp')
...
outlookbar.additem('员工岗位调动', t, 'movecheck.html')
...
outlookbar.additem('添加管理员', t, 'hjc/addmanager.jsp')
